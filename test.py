...
# Add PyImpact.
py_impact = PyImpact()
logger = Logger(log_commands_in_build=True, path=EXAMPLE_CONTROLLER_OUTPUT_PATH.joinpath("log.txt"))
c.add_ons.extend([logger, camera, audio_initializer, py_impact])
# Set the output path.
